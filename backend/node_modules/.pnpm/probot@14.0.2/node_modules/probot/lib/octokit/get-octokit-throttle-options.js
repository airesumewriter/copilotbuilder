...
export async function getOctokitThrottleOptions(options) {
...
let Redis = null;
async function getRedisClient({ redisConfig }) {
    Redis ??= (await npxImport("ioredis@5.7.0", { onlyPackageRunner: true }))
        .Redis;
    if (redisConfig)
